...
import UserViewBilling from 'src/views/clienti/view/UserViewBilling'
import UserViewAccount from 'src/views/clienti/view/UserViewAccount'
import UserViewSecurity from 'src/views/clienti/view/UserViewSecurity'
import UserViewConnection from 'src/views/clienti/view/UserViewConnection'
import UserViewNotification from 'src/views/clienti/view/UserViewNotification'
...
const UserViewRight = ({ tab, invoiceData }) => {
  ...
  const handleChange = (event, value) => {
    ...
    router
      .push({
        pathname: `/clienti/view/${value.toLowerCase()}`
      })
